...
def main():
    ...
    args.data = '/home/sunx/dataset/scene'
    print args
    # create model
    ...
    if args.arch.lower().startswith('wideresnet'):
        ...
        optimizer = torch.optim.SGD([{'params': model.fc.parameters()}], lr=args.lr, momentum=args.momentum)
    ...
    # optimizer = torch.optim.SGD(model.module.fc.parameters(), lr=args.lr,
