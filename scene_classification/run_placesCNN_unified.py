...
for index in range(1,58):
    ...
    img = Image.open('/home/sunx/samples/'+str(index)+'.jpg')
    input_img = V(tf(img).unsqueeze(0))
    os.remove('/home/sunx/samples/'+str(index)+'.txt')
    f = open('/home/sunx/samples/'+str(index)+'.txt', 'a')
    # forward pass
    ...
    f.write('RESULT ON ' + str(index) + '.jpg\n')
    # print('RESULT ON ' + index + '.jpg')
