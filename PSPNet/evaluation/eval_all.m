...
switch data_name
    case 'ADE20K'
        ...
        data_root = '/home/sunx/dataset/demoImages'; %root path of dataset
        eval_list = 'list.txt'; %evaluation list, refer to lists in folder 'samplelist'
        save_root = 'mc_result/ADE20K/val/pspnet50_474/'; %root path to store the result image
