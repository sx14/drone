...
pspnet_root_path = pspnet_root();
addpath(fullfile(pspnet_root_path, 'matlab')); %add matcaffe path
addpath(genpath('visualizationCode'));
model_weights = fullfile(pspnet_root_path,'evaluation/model/pspnet50_ADE20K.caffemodel');
model_deploy = fullfile(pspnet_root_path,'evaluation/prototxt/pspnet50_ADE20K_473.prototxt');
